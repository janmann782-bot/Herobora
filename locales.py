...
RU = {
    ...
    'olddoc_options': (
        ...
        'Сид: {seed}\n'
        'Следы от кружки: {stains}\n\n'
        'Новый вариант меняет бумагу, разрывы, яркость и расположение пятен'
    ),
    'olddoc_reseeded': 'Новый вариант документа готов',
    'olddoc_stains_on': 'Следы от кружки включены',
    'olddoc_stains_off': 'Следы от кружки выключены',
}
